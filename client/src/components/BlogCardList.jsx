...
const BlogCardList = ({ blog }) => {
    ...
    return (
        <div className="bg-white w-230 dark:bg-gray-700 dark:border-gray-600 flex flex-col md:flex-row md:gap-10 p-5 rounded-2xl mt-6 shadow-lg border h-40  transition-all">
            <div>
            <img src={blog.thumbnail} alt="" className='rounded-lg h-30 md:w-[250px]  hover:scale-105 transition-all' />
