        ...
        <div className='bg-gray-100 dark:bg-gray-800 pb-10'>
            ...
            <div className='max-w-7xl mx-auto flex gap-6'>
                ...
                <div className='bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10'>
                    <h1 className='text-2xl font-semibold'>Populat Categories</h1>
                    <div className='my-5 flex flex-wrap gap-3'>
                        {
                            ["Blogging", "Web Development", "Digital Marketing", "Cooking", "Photography", "Sports"].map((iteam, index) => {
                                return <Badge className="cursor-pointer">{iteam}</Badge>
                            })
                        }
                    </div>
                    <h1 className='text-xl font-semibold'>Sucribe Newsletter</h1>
