...
const Navbar = () => {
    ...
    const user = false;
    return (
        <div className='py-2 dark:bg-gray-800 dark:border-b-gray-600 border-b-gray-300 border-2 bg-white z-50'>
            <div className='max-w-7xl mx-auto flex justify-between items-center px-4 md:px-0'>
                ...
                <div className='flex gap-7 items-center'>
                    ...
                    <div className='relative hidden md:block'>
                        <Input type="text" placeholder="search.." className="border border-gray-700 dark:bg-gray-900 bg-gray-300 w-[300px] hidden md:block" />
