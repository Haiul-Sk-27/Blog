...
const Profile = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const res = await axios.put(`https://blog-uv51.onrender.com/api/v1/user/updateProfile`, formData, {
        headers: {
    ...
    <div className='pt-20 md:ml-[320px] md:h-screen'>
      <div className='max-w-6xl mx-auto mt-8 '>
        <Card className=" flex md:flex-row flex-col gap-10 p-6 md:p-10 dark:bg-gray-800 mx-4 md:mx-0">
          ...
          {/* info section */}
          <div>
            <h1 className='font-bold text-center md:text-start text-4xl mb-2'>Welcome {user?.firstName}!</h1>
            <p className=''><span className='font-semibold'>Email : </span>{user?.email}</p>
            <div className='flex flex-col gap-2 items-start justify-start my-2'>
              <Label className="">About Me</Label>
              <p className='border dark:border-gray-600 p-2  rounded-lg'>{user?.bio || "I'm a passionate web developer and content creator focused on frontend technologies. When I'm not coding, you can find me writing about tech, hiking, or experimenting with new recipes."}</p>
                ...
                <div className='grid gap-4 py-4'>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      spellCheck="false"   
                      className="col-span-3 text-gray-500 w-full rounded-md border border-gray-300 p-2 focus:outline-none focus:ring-2"
                      rows={3}
                    />
                  </div>
                  <div >
