  ...
  const getTotalComments = async () => {
    try {
      ...
      const res = await axios.get(
        "https://blog-uv51.onrender.com/api/v1/comment/my-blogs/comments",
        {
          headers: {
      ...
      console.log("API Response:", res.data); // Debug: check what API returns

      if (res.data.success) {
        setAllComments(res.data.comments);
        console.log("Comments state updated:", res.data.comments); // Debug state
      } else {
