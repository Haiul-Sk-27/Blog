...
const YourBlog = () => {
    ...
    const getOwnBlog = async () => {
        try {
            const res = await axios.get(`https://blog-uv51.onrender.com/api/v1/blog/get-own-blog`, { withCredentials: true })
            if (res.data.success) {
                            ...
                            {blog?.map((item, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell className="flex gap-4 items-center">
                                        <img src={item.thumbnail} alt="" className='w-20 h-15 rounded-md hidden md:block' />
